intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function() {
    ...
    ///   <param name="dataType" type="String">A string movieIdentifying the data type to use</param>
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new transport object to use with the data type provmovieIded in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'Callbacks': function() {
    /// <signature>
    ///   <summary>A multi-purpose callbacks list object that provmovieIdes a powerful way to manage callback lists.</summary>
  ...
  'cssHooks': function() {
    /// <summary>Hook directly into jQuery to overrmovieIde how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'fn.extend': function() {
    /// <signature>
    ///   <summary>Merge the contents of an object onto the jQuery prototype to provmovieIde new jQuery instance methods.</summary>
  ...
  'grep': function() {
    ...
    ///   <param name="invert" type="Boolean">If "invert" is false, or not provmovieIded, then the function returns an array consisting of all elements for which "callback" returns true.  If "invert" is true, then the function returns an array consisting of all elements for which "callback" returns false.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'hasData': function() {
  ...
  'post': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds. Required if dataType is provmovieIded, but can be null in that case.</param>
  ...
  'when': function() {
    /// <signature>
    ///   <summary>ProvmovieIdes a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'child': function() {
    ...
    ///   <param name="parent" type="String">Any valmovieId selector.</param>
  ...
  'descendant': function() {
    ...
    ///   <param name="ancestor" type="String">Any valmovieId selector.</param>
  ...
  'fadeOut': function() {
    /// <signature>
    ///   <summary>HmovieIde the matched elements by fading them to transparent.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'fadeToggle': function() {
    /// <signature>
    ///   <summary>Display or hmovieIde the matched elements by animating their opacity.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="easing" type="String">A string indicating which easing function to use for the transition.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
  ...
  'hmovieIdden': function() {
    /// <summary>Selects all elements that are hmovieIdden.</summary>
  },
  'hmovieIde': function() {
    /// <signature>
    ///   <summary>HmovieIde the matched elements.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'movieId': function() {
    ...
    ///   <param name="movieId" type="String">An movieId to search for, specified via the movieId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
  ...
  'innerWmovieIdth': function() {
    /// <summary>Get the current computed wmovieIdth for the first element in the set of matched elements, including padding but not border.</summary>
    /// <returns type="Number" />
  },
  'input': function() {
  ...
  'multiple': function() {
    ...
    ///   <param name="selector1" type="String">Any valmovieId selector.</param>
    ///   <param name="selector2" type="String">Another valmovieId selector.</param>
    ///   <param name="selectorN" type="String">As many more valmovieId selectors as you like.</param>
    /// </signature>
  },
  'next': function() {
    /// <signature>
    ///   <summary>Get the immediately following sibling of each element in the set of matched elements. If a selector is provmovieIded, it retrieves the next sibling only if it matches that selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'next adjacent': function() {
    ...
    ///   <param name="prev" type="String">Any valmovieId selector.</param>
  ...
  'outerWmovieIdth': function() {
    /// <signature>
    ///   <summary>Get the current computed wmovieIdth for the first element in the set of matched elements, including padding and border.</summary>
    ///   <param name="includeMargin" type="Boolean">A Boolean indicating whether to include the element's margin in the calculation.</param>
    ///   <returns type="Number" />
    /// </signature>
  },
  ...
  'replaceWith': function() {
    /// <signature>
    ///   <summary>Replace each element in the set of matched elements with the provmovieIded new content and return the set of elements that was removed.</summary>
  ...
  'slmovieIdeDown': function() {
    /// <signature>
    ///   <summary>Display the matched elements with a slmovieIding motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slmovieIdeToggle': function() {
    /// <signature>
    ///   <summary>Display or hmovieIde the matched elements with a slmovieIding motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slmovieIdeUp': function() {
    /// <signature>
    ///   <summary>HmovieIde the matched elements with a slmovieIding motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'target': function() {
    /// <summary>Selects the target element indicated by the fragment movieIdentifier of the document's URI.</summary>
  },
  'text': function() {
    /// <signature>
  ...
  'toggle': function() {
    /// <signature>
    ///   <summary>Display or hmovieIde the matched elements.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    ...
    /// <signature>
    ///   <summary>Display or hmovieIde the matched elements.</summary>
    ///   <param name="showOrHmovieIde" type="Boolean">A Boolean indicating whether to show or hmovieIde the elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'wmovieIdth': function() {
    /// <signature>
    ///   <summary>Set the CSS wmovieIdth of each element in the set of matched elements.</summary>
    ...
    /// <signature>
    ///   <summary>Set the CSS wmovieIdth of each element in the set of matched elements.</summary>
    ///   <param name="function(index, wmovieIdth)" type="Function">A function returning the wmovieIdth to set. Receives the index position of the element in the set and the old wmovieIdth as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'wrap': function() {
